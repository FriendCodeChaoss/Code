from HelperScripts.Create_Shape import Rect, Circle, Oval, Polygon
from HelperScripts.Color import gradient, rgb
from HelperScripts.ManageScene import Group
from HelperScripts.Util import with_names
###starting scene 
#background
def Start(screen):
    sky = Rect(200, 130, 400, 260, fill=gradient(rgb(255, 69, 0), rgb(255, 165, 0), rgb(255, 160, 122), rgb(255, 105, 180), rgb(150, 0, 150), start='bottom'),Screen=screen,render=False)
    sun = Group(
        Circle(200, 220, 80, fill=gradient(rgb(255, 255, 255), rgb(255, 255, 255), rgb(255, 255, 100),start="center"),Screen=screen, opacity=255,render=False),
    )
    background = Group(
        Rect(200, 330, 400, 150, fill=gradient(rgb(255, 40, 0), rgb(255, 165, 0), start='top'),Screen=screen,render=False),
        Polygon(0, 300, 400, 330, 400, 550, 0, 550, fill=gradient(rgb(120, 20, 0), rgb(255, 70, 0), start='bottom'),Screen=screen,render=False),
        #left clouds
        Oval(100, 235, 200, 20, fill=gradient(rgb(255, 90, 0), rgb(255, 10, 0), rgb(220, 0, 0), start='left'),Screen=screen,render=False),
        Oval(70, 70, 200, 100, fill=gradient(rgb(150, 0, 150), rgb(150, 0, 150), rgb(255, 135, 180), rgb(255, 160, 122), start='top'),Screen=screen,render=False),
        Oval(250, 200, 70, 30, fill=gradient(rgb(255, 10, 0), rgb(255, 100, 0), start='left'),Screen=screen,render=False),
        Oval(270, 100, 100, 60, fill=gradient(rgb(250, 165, 140), rgb(255, 127, 80), start='top'),Screen=screen,render=False),
        Oval(370, 125, 200, 70, fill=gradient(rgb(255, 160, 122), rgb(255, 127, 80), rgb(255, 165, 0), start='top'),Screen=screen,render=False),
        Oval(300, 50, 400, 100, fill=gradient(rgb(150, 0, 150), rgb(150, 0, 150), rgb(255, 135, 180), rgb(255, 160, 122), start='top'),Screen=screen,render=False),
    )

    tree = Group(
        Polygon(-20, 350, 20, 350, 150, 150, 170, 100, 135, 150, fill=gradient(rgb(227, 60, 0), rgb(180, 50, 0), rgb(50, 0, 0), start='bottom'),Screen=screen,render=False),
        Polygon(170, 100, 150, 150, 170, 230, 180, 150, fill=gradient(rgb(100, 100, 70), rgb(180, 50, 0), start='top'),Screen=screen,render=False),
        Polygon(170, 100, 190, 140, 230, 180, 220, 130, fill=gradient(rgb(100, 100, 70), rgb(180, 50, 0), start='top'),Screen=screen,render=False),
        Polygon(170, 100, 140, 150, 70, 210, 105, 140, fill=gradient(rgb(100, 100, 70), rgb(180, 50, 0), start='top'),Screen=screen,render=False),
        Polygon(170, 100, 105, 130, 60, 130, 105, 100, fill=gradient(rgb(100, 100, 70), rgb(120, 80, 40), rgb(180, 50, 0), start='right-top'),Screen=screen,render=False),
    )
    return with_names(sky,sun,background,tree)
...
###chef
#rotations
f = Oval(170, 270, 50, 30, fill=rgb(50, 30, 0))
f.rotate(-20, 170, 270)
a = Oval(150, 220, 30, 50, fill=rgb(50, 30, 0))
a.rotate(-45, 150, 220)
b = Oval(250, 220, 30, 50, fill=rgb(50, 30, 0))
b.rotate(45, 250, 220)
h = Oval(230, 270, 50 , 30, fill=rgb(50, 30, 0))
h.rotate(20, 230, 270)
e = Oval(170, 270, 40, 20, fill=rgb(255, 255, 230))
e.rotate(-20, 170, 270)
g = Oval(230, 270, 40 , 20, fill=rgb(255, 255, 230))
g.rotate(20, 230, 270)
c = Oval(150, 220, 20, 40, fill=rgb(255, 255, 230))
c.rotate(-45, 150, 220)
d = Oval(250, 220, 20, 40, fill=rgb(255, 255, 230))
d.rotate(45, 250, 220)
k = Rect(152, 208, 15, 30, fill=rgb(50, 30, 0))
k.rotate(-45, 154, 208)
l = Rect(233, 198, 15, 30, fill=rgb(50, 30, 0))
l.rotate(45, 233, 205)
i = Rect(158, 208, 5, 30, fill=rgb(139, 0, 0))
i.rotate(-45, 158, 208)
j = Rect(239, 205, 5, 30, fill=rgb(139, 0, 0))
j.rotate(45, 239, 205)
